...
let ymin = -0.25
    plot(title="Analytic structure", xlim=(-0.4, 0.1), ylim=(ymin, 0.0), frame=:origin)
    ...
    scatter!([E_Tcc], m=(8, :+, stroke(6)), mc=:black, lab="Tcc pole")
    plot!(xlab="Re E", ylab="Im E", leg=:bottomleft)
    #
